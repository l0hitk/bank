    ...
    public partial class Form7 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
                ...
                {
                    SqlCommand cmd2 = new SqlCommand("update pinn set bal=bal+'" + Form6.amt + "'where username = '" + Form3.S1 + "'", con);
                    cmd2.ExecuteNonQuery();
                SqlCommand command1 = new SqlCommand("insert into ball(username,amt,bal,date) select '" + Form3.S1 + "','" + Form6.amt + "',bal,getdate() from pinn where username='" + Form3.S1 + "'", con);
